...
export const translations = {
  en: {
    ...
    site: {
      ...
      apps: {
        title: 'Apps',
        subtitle: 'Explore ready-made tools, experiments, and operating system demos.',
        ...
        categories: {
          ...
          systems: 'Operating system demos',
        },
      },
    ...
    xp: {
      ...
      loggingIn: 'Loading your personal settings...',
  ...
  ru: {
    ...
    site: {
      ...
      apps: {
        title: 'Приложения',
        subtitle: 'Обзор готовых инструментов, прототипов и системных демо.',
    ...
    xp: {
      ...
      loggingIn: 'Загрузка личных параметров...',
  ...
  fr: {
    ...
    site: {
      ...
      apps: {
        title: 'Applications',
        subtitle: 'Découvrez outils prêts, prototypes et démos de systèmes.',
    ...
    xp: {
      ...
      turnOff: 'Arrêter',
      loggingIn: 'Chargement de vos paramètres personnels...',
  ...
  es: {
    ...
    site: {
      ...
      apps: {
        title: 'Aplicaciones',
        subtitle: 'Explora herramientas listas, prototipos y demos de sistemas.',
    ...
    xp: {
      ...
      loggingIn: 'Cargando sus configuraciones personales...',
  ...
  ja: {
    ...
    site: {
      ...
      apps: {
        title: 'アプリ',
        subtitle: '完成したツール、プロトタイプ、システムデモをチェック。',
  ...
  ko: {
    ...
    site: {
      ...
      apps: {
        title: '앱',
        subtitle: '준비된 도구, 프로토타입, 시스템 데모를 탐색하세요.',
